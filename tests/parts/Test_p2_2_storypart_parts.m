...
%   ,'n'; the writer opens "wb") -- no CRLF translation, no 'wt'.
    ...
    methods (Test)
        ...
        function test_twelve_feature_stubs_raise_notyetported(testCase)
            % Edge/Regression (validate_P2-2 Bar 6): the 12 still-stubbed feature
            ...
            calls = { ...
                ...
                @() dp.get_style("Normal","paragraph"),        'DocumentPart.get_style'; ...
                @() dp.get_style_id("Normal","paragraph"),     'DocumentPart.get_style_id'; ...
                ...
                @() sp.styles(),                  'StylesPart.styles'; ...
                @() st.settings(),                'SettingsPart.settings'; ...
                @() np.numbering_definitions(),   'NumberingPart.numbering_definitions'};
            testCase.verifyEqual(size(calls, 1), 12, 'exactly 12 feature stubs pinned');
